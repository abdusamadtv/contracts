<template>
    <div class="contracts">
        ...
        <el-table :data="currentContracts" style="width: 900px;">
            ...
            <el-table-column prop="sid" label="Seller ID">
            </el-table-column>
            <el-table-column prop="cid" label="Client ID">
            </el-table-column>
            <el-table-column prop="number" label="Number">
            </el-table-column>
            <el-table-column prop="signed_at" label="Signed at">
            </el-table-column>
            <el-table-column prop="valid_till" label="Valid till">
            </el-table-column>
            <el-table-column label="Actions" width="100">
                <template slot-scope="scope">
                    <el-button @click="showEditDialog(scope.row)" type="warning" title="Edit contract" round size="small" icon="el-icon-edit-outline"></el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination @current-change="handleCurrentPageChange" :current-page.sync="currentPage" :page-size="5" layout="total, prev, pager, next, jumper" :total="currentItemsTotal">
        </el-pagination>
        <el-dialog title="Edit contract" :visible.sync="editContractDialog" center>
            <el-form ref="form" :model="currentContract" label-width="120px">
                ...
                <el-form-item label="Signed at">
                    <el-col :span="11">
                        <el-date-picker type="date" placeholder="Pick a date" v-model="currentContract.signed_at" style="width: 100%;"></el-date-picker>
                    </el-col>
                </el-form-item>
                <el-form-item label="Valid Till">
                    <el-col :span="11">
                        <el-date-picker type="date" placeholder="Pick a date" v-model="currentContract.valid_till" style="width: 100%;"></el-date-picker>
                    </el-col>
                </el-form-item>
            </el-form>
